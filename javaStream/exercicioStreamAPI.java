...
public class exercicioStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Pegue os números pare e maiores que 2 e coloque em uma lista: ");
        List<Integer> paresMaioresQueDois = numerosAleatorios.stream().map(Integer::parseInt).filter(i -> i % 2 == 0 && i > 2).collect(Collectors.toList());
