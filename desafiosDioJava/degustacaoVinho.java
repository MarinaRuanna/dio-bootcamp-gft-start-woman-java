...
Durante uma competição de degustação,
uma garrafa de vinho é aberta e dividia em taças para que os cinco competidores possam provar.
...
determine o número de participantes que receberam a resposta correta.
...
public class degustacaoVinho {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < respostasCompetidoresSplit.length ; i++ ) {
            if (respostasCompetidoresSplit[i].equals(T)) count++;
        }
